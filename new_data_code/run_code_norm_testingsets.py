...
from linear_network import BasicNetwork, train_loop, test_loop
...
if __name__ == "__main__":
    ...
    new_name = "making normalized testing sets"
    wandb.run.name = new_name
    wandb.run.save()

    dataset = BasicDataset("../../data/testing_25000pix_200m_greaterthan0.csv")
    torch.save(dataset, "new_data/testing_25000_pairNorm_desert.pt")
    print("desert data saved")

    dataset = BasicDataset("../../data/testing_NYC_25000pix_200m_greaterthan0.csv")
    torch.save(dataset, "new_data/testing_25000_pairNorm_NYC.pt")
    print("NYC data saved")
