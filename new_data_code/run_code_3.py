...
from linear_network_GELU import BasicNetwork, train_loop, test_loop
...
if __name__ == "__main__":
    ...
    new_name = "Pair Normalized, multitask, GELU, DS3"
    wandb.run.name = new_name
    wandb.run.save()
    
    #dataset = BasicDataset("../../data/training_75000pix_200m_greaterthan0_3.csv")
    #torch.save(dataset, "new_data/training_75000_pairNorm__greaterthan0_3.pt")
    #print("data saved 3")

    dataset = torch.load("new_data/training_75000_pairNorm__greaterthan0_3.pt")
    print("data loaded")
