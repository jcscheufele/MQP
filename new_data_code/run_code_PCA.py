...
if __name__ == "__main__":
    ...
    new_name = "PCA experiment"
    wandb.run.name = new_name
    wandb.run.save()

    dataset = BasicDataset("../../data/forestmini.csv")
    torch.save(dataset, "new_data/miniPCA.pt")
    print("data saved 1")

    """dataset = BasicDataset("../../data/training_75000pix_200m_2.csv")
    torch.save(dataset, "new_data/training_75000pix_dataset_200m_2.pt")
    print("data saved 2")

    dataset = BasicDataset("../../data/training_75000pix_200m_3.csv")
    torch.save(dataset, "new_data/training_75000pix_dataset_200m_3.pt")
    print("data saved 3")"""
