...
if __name__ == "__main__":
    ...
    new_name = "Pair Normalized, multitask, GELU, DS2"
    wandb.run.name = new_name
    wandb.run.save()

    #dataset = BasicDataset("../../data/training_75000pix_200m_greaterthan0_2.csv")
    #torch.save(dataset, "new_data/training_75000_pairNorm__greaterthan0_2.pt")
    #print("data saved 2")
    
    dataset = torch.load("new_data/training_75000_pairNorm__greaterthan0_2.pt")
    print("data loaded")
