...
from linear_network_alt_newarch_straightlayers import BasicNetwork, train_loop, test_loop
...
if __name__ == "__main__":
    ...
    new_name = "Pair Normalized, single network, straight layers arch, DS0"
    ...
    dataset = torch.load("new_data/training_75000_pairNorm__greaterthan0_0.pt")
    print("data loaded")
