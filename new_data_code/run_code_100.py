...
if __name__ == "__main__":
    ...
    wandb.run.name = "F:100k normalized 1000 epochs"
    #dataset = BasicDataset("../../data/training_100000pix_200m.csv")
    #torch.save(dataset, "new_data/training_100000pix_dataset.pt")
    #print("data saved 8")
    dataset = torch.load("new_data/training_100000pix_dataset.pt")
    print("data loaded")
