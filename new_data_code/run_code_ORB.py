from dataset_ORB import BasicDataset
from linear_network_ORB import BasicNetwork, train_loop, test_loop
...
if __name__ == "__main__":
    ...
    #dataset = BasicDataset("../../data/training_5000pix_200m.csv")
    #torch.save(dataset, "new_data/training_5000_ORB_pix_dataset.pt")
    #print("data saved")
    dataset = torch.load("new_data/training_100000_ORB_pix_dataset.pt")
    print("data loaded")
